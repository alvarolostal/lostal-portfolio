export default function Marquee() {
  ...
  return (
    <section id="habilidades" className="py-20 border-t border-white/10 border-b border-white/10 bg-acid text-black rotate-1 scale-105 transform origin-left z-20 relative">
