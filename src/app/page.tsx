    ...
    <main>
      ...
      <section id="projects" className="py-32 px-6 md:px-20 max-w-[1800px] mx-auto">
        ...
        <div className="flex flex-col">
          {/* Proyecto 1 */}
          <Link href="#" className="project-item group py-12 flex flex-col md:flex-row justify-between items-center hoverable" data-color="#3b82f6">
            <div className="text-4xl md:text-6xl font-sans font-bold uppercase tracking-tighter group-hover:translate-x-4 transition-transform">Rediseño Vivenza Expo</div>
            <div className="project-meta flex gap-8 font-mono text-xs md:text-sm text-gray-500 mt-4 md:mt-0">
          ...
          {/* Proyecto 2 */}
          <Link href="#" className="project-item group py-12 flex flex-col md:flex-row justify-between items-center hoverable" data-color="#c4ab2f">
            <div className="text-4xl md:text-6xl font-sans font-bold uppercase tracking-tighter group-hover:translate-x-4 transition-transform">Creative Hands</div>
            <div className="project-meta flex gap-8 font-mono text-xs md:text-sm text-gray-500 mt-4 md:mt-0">
              <span>ECOMMERCE / PWA</span>
              <span>2024</span>
            </div>
          </Link>
